...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(INT_5_GPIO_Port, INT_5_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LUCES_1_Pin|LUCES_2_Pin|LUCES_3_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = LUCES_1_Pin|LUCES_2_Pin|LUCES_3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
